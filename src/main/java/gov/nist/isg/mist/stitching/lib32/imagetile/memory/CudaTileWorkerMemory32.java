 ...
 * @version 1.0
 */
public class CudaTileWorkerMemory32 extends TileWorkerMemory {
   ...
   */
  public CudaTileWorkerMemory32(ImageTile<?> initTile) {
    ...
    JCudaDriver.cuMemAllocHost(this.fftIn, super.getWidth() * super.getHeight() * Sizeof.FLOAT);
    JCudaDriver.cuMemAlloc(this.pcmIn, CudaImageTile32.fftSize * Sizeof.FLOAT * 2);
    JCudaDriver.cuMemAlloc(this.pcm, super.getWidth() * super.getHeight() * Sizeof.FLOAT);
    JCudaDriver.cuMemAlloc(this.maxOut, super.getWidth() * super.getHeight() * Sizeof.FLOAT);
