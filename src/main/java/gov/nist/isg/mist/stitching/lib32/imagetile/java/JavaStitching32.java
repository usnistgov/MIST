...
//      return triple;
    ...
    List<CorrelationTriple> peaks =
        UtilFnsStitching32.multiPeakCorrelationMatrixNoSort(pcm, Stitching32.NUM_PEAKS, t1.getWidth(),
            t2.getHeight());
   ...
   */
  public static float[][] peakCorrelationMatrix(JavaImageTile32 t1, JavaImageTile32 t2, float[][] ncc) throws FileNotFoundException {
    if (!t1.hasFft())
      t1.computeFft();
