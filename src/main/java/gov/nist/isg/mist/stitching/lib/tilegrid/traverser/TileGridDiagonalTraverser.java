 ...
 * @param <T>
 */
public class TileGridDiagonalTraverser<T> implements TileGridTraverser<ImageTile<T>>, Iterator<ImageTile<T>> {
   ...
   * @param subgrid
   */
  public TileGridDiagonalTraverser(TileGrid<ImageTile<T>> subgrid) {
