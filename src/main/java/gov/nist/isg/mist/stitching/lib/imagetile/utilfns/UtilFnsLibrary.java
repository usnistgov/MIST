...
/**
 * Wrapper for library <b>util-fns</b><br>
...
public class UtilFnsLibrary {
  ...
  /**
   * normalize resulting vector to have magnitude <= 1<br>
   * Original signature : <code>void elt_prod_conj_norm(double*, double*, double*, int)</code><br>
   * <i>native declaration : util-fns.h:1207</i>
   * 
   * @param res the res
   * @param c1 the c1
   * @param c2 the c2
  ...
  /**
   * Original signature : <code>int reduce_max_abs(double*, int)</code><br>
   * <i>native declaration : util-fns.h:1209</i>
   * 
  ...
  /**
   * Original signature :
   * <code>int* get_multi_max_no_sort(double*, int, int, int, double, int*)</code> <br>
   * <i>native declaration : util-fns.h:1211</i>
   * 
   * @param v the v
   * @param nPeaks the n peaks
