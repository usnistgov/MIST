 ...
 * @param <T>
 */
public class TileGridColumnTraverser<T> implements TileGridTraverser<ImageTile<T>>, Iterator<ImageTile<T>>{
   ...
   * @param subgrid
   */
  public TileGridColumnTraverser(TileGrid<ImageTile<T>> subgrid) {
