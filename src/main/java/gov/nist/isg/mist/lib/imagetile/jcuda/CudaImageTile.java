...
public class CudaImageTile extends ImageTile<CUdeviceptr> {
  ...
  public void computeFft() {
    ...
    JCudaDriver.cuMemAlloc(ptr, super.getWidth() * super.getHeight() * Sizeof.DOUBLE);

    JCudaDriver.cuMemAlloc(this.fft, fftSize * Sizeof.DOUBLE * 2);
    ...
    JCufft.cufftExecD2Z(plan_fwd[super.getDev()], ptr, this.fft);
  ...
  public void computeFft(DynamicMemoryPool<CUdeviceptr> pool, TileWorkerMemory memory,
    ...
    JCufft.cufftExecD2Z(plan_fwd[this.getThreadID()], fftIn, this.fft);
