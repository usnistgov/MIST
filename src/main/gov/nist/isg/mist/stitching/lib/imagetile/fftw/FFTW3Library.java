...
public class FFTW3Library {
  ...
  /**
   * Original signature : <code>fftw_plan fftw_plan_dft(int, const int*, 
   * 							double*, double*, int, unsigned)</code><br>
  ...
  /**
   * Original signature : <code>fftw_plan fftw_plan_dft_1d(int, double*, 
   * double*, int, unsigned)</code><br>
  ...
  /**
   * Original signature : <code>fftw_plan fftw_plan_dft_2d(int, int, double*,
   * double*, int, unsigned)</code><br>
  ...
  /**
   * Original signature : <code>fftw_plan fftw_plan_dft_3d(int, int, int, 
   * double*, double*, int, unsigned)</code><br>
  ...
  /**
   * Original signature : <code>fftw_plan fftw_plan_many_dft(int, const int*,
   * int, double*, const int*, int, int, double*, const int*, int, int, int,
   * unsigned)</code><br>
  ...
  /**
   * Original signature : <code>void fftw_execute_split_dft(const fftw_plan,
   * double*, double*, double*, double*)</code><br>
  ...
  /**
   * Original signature : <code>fftw_plan fftw_plan_many_dft_r2c(int,
   * const int*, int, double*, const int*, int, int, double*, const int*,
   * int, int, unsigned)</code><br>
  ...
  /**
   * Original signature : <code>fftw_plan fftw_plan_dft_r2c(int, const int*,
   * double*, double*, unsigned)</code><br>
  ...
  /**
   * Original signature : <code>fftw_plan fftw_plan_dft_r2c_1d(int, double*,
   * double*, unsigned)</code><br>
  ...
  /**
   * Original signature :
   * <code>fftw_plan fftw_plan_dft_r2c_2d(int, int, double*, double*, unsigned)</code> <br>
   ...
   * const int*, int, int, double*, const int*, int, int, unsigned)</code> <br>
  ...
  /**
   * Original signature : <code>void fftw_execute_split_dft_r2c(const fftw_plan, double*, 
   * double*, double*)</code> <br>
  ...
  /**
   * Original signature : <code>void fftw_execute_split_dft_c2r(const fftw_plan, double*, 
   * double*, double*)</code> <br>
  ...
  /**
   * Original signature : <code>int fftw_import_wisdom_from_file(FILE*)
   * </code><br>
